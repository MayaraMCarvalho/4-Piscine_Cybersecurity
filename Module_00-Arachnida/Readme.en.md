...
Available in: [🇧🇷 Português](README.pt.md)
...
Aqui está a tradução do README.md para o inglês, mantendo toda a formatação, incluindo emojis, blocos de código e links.
